...
const mockTasks: Task[] = [
  { id: "1", agentId: "weather", description: "Fetching weather data", status: "running", startedAt: Date.now() - 1200, durationMs: 1200 },
  { id: "2", agentId: "calendar", description: "Loading calendar events", status: "completed", startedAt: Date.now() - 800, durationMs: 800 },
  { id: "3", agentId: "research", description: "Web search: AI trends 2025", status: "pending", startedAt: Date.now() },
  { id: "4", agentId: "system", description: "Opening Calendar app", status: "completed", startedAt: Date.now() - 300, durationMs: 300 },
];
...
export function createMockNexusBridge(): NexusBridge {
  return {
    async getTasks() { return mockTasks; },
    async getAgents() { return mockAgents; },
